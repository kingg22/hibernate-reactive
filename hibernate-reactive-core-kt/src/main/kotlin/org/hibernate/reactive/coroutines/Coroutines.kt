...
interface Coroutines {
    ...
    interface AbstractQuery {
         ...
         */
        fun setParameter(parameter: Int, argument: Any): AbstractQuery
         ...
         * @param argument the argument to set
         */
        fun setParameter(parameter: String, argument: Any): AbstractQuery
         ...
         */
        fun <T> setParameter(parameter: Parameter<T>, argument: T): AbstractQuery
    ...
    interface SelectionQuery<R> : AbstractQuery {
         ...
         */
        @Incubating
        fun setPage(page: Page): SelectionQuery<R> = apply {
        ...
        fun setCacheStoreMode(cacheStoreMode: CacheStoreMode?): SelectionQuery<R> = setCacheMode(
        ...
        fun setCacheRetrieveMode(cacheRetrieveMode: CacheRetrieveMode?): SelectionQuery<R> = setCacheMode(
            CacheModeHelper.interpretCacheMode(
        ...
        fun setFlushMode(flushModeType: FlushModeType?): SelectionQuery<R> =
            setFlushMode(FlushModeTypeHelper.getFlushMode(flushModeType))
         ...
         */
        fun setLockMode(lockModeType: LockModeType): SelectionQuery<R> =
         ...
         */
        fun setLockMode(alias: String?, lockMode: LockMode?): SelectionQuery<R>
         ...
         * @see org.hibernate.query.Query.setLockMode
         */
        fun setLockMode(alias: String?, lockModeType: LockModeType): SelectionQuery<R> =
            setLockMode(alias, LockModeConverter.convertToLockMode(lockModeType))
        ...
        // Overrides
        override fun setParameter(parameter: Int, argument: Any): SelectionQuery<R>

        override fun setParameter(parameter: String, argument: Any): SelectionQuery<R>

        override fun <T> setParameter(parameter: Parameter<T>, argument: T): SelectionQuery<R>
    ...
    interface MutationQuery : AbstractQuery {
        ...
        // overrides
        override fun setParameter(parameter: Int, argument: Any): MutationQuery

        override fun setParameter(parameter: String, argument: Any): MutationQuery

        override fun <T> setParameter(parameter: Parameter<T>, argument: T): MutationQuery
    ...
    interface Query<R> :
        ...
        @Incubating
        override fun setPage(page: Page): Query<R> = apply { super.setPage(page) }
        ...
        override fun setCacheStoreMode(cacheStoreMode: CacheStoreMode?): Query<R> = apply {
            super.setCacheStoreMode(cacheStoreMode)
        }

        override fun setCacheRetrieveMode(cacheRetrieveMode: CacheRetrieveMode?): Query<R> = apply {
            super.setCacheRetrieveMode(cacheRetrieveMode)
        }

        override fun setFlushMode(flushMode: FlushMode?): Query<R>

        override fun setFlushMode(flushModeType: FlushModeType?): Query<R> = apply { super.setFlushMode(flushModeType) }

        override fun setLockMode(lockMode: LockMode?): Query<R>

        override fun setLockMode(lockModeType: LockModeType): Query<R> = apply { super.setLockMode(lockModeType) }

        override fun setLockMode(alias: String?, lockMode: LockMode?): Query<R>

        override fun setLockMode(alias: String?, lockModeType: LockModeType): Query<R> =
            apply { super.setLockMode(alias, lockModeType) }

        override fun setPlan(entityGraph: EntityGraph<R>?): Query<R>

        override fun enableFetchProfile(profileName: String?): Query<R>

        override fun setParameter(parameter: Int, argument: Any): Query<R>

        override fun setParameter(parameter: String, argument: Any): Query<R>

        override fun <T> setParameter(parameter: Parameter<T>, argument: T): Query<R>
    ...
    interface QueryProducer {
         ...
         */
        fun <R> createSelectionQuery(queryString: String?, resultType: Class<R>?): SelectionQuery<R>
         ...
         * @see jakarta.persistence.EntityManager.createQuery
         */
        fun <R> createQuery(queryString: String?, resultType: Class<R>?): SelectionQuery<R>
         ...
         * @see jakarta.persistence.EntityManager.createQuery
         */
        fun <R> createNamedQuery(queryName: String?, resultType: Class<R>): SelectionQuery<R>
         ...
         */
        fun <R> createNativeQuery(queryString: String?, affectedEntities: AffectedEntities): Query<R>
         ...
         */
        fun <R> createNativeQuery(queryString: String?, resultType: Class<R>): SelectionQuery<R>
         ...
         * @see jakarta.persistence.EntityManager.createNativeQuery
         */
        fun <R> createNativeQuery(queryString: String?, resultSetMapping: ResultSetMapping<R>?): SelectionQuery<R>
        ...
        fun <T> getResultSetMapping(resultType: Class<T>?, mappingName: String?): ResultSetMapping<T>

        /** Obtain a named [EntityGraph] */
        fun <T> getEntityGraph(rootType: Class<T>?, graphName: String?): EntityGraph<T>
        ...
        fun <T> createEntityGraph(rootType: Class<T>?, graphName: String?): EntityGraph<T>
    ...
    interface Session :
         ...
         */
        @JvmSynthetic
        suspend fun <T> find(entityClass: Class<T>, id: Any?): T?
         ...
         */
        @JvmSynthetic
        suspend fun <T> find(entityClass: Class<T>, id: Any?, lockMode: LockMode?): T?
         ...
         */
        @JvmSynthetic
        suspend fun <T> find(entityClass: Class<T>, id: Any?, lockModeType: LockModeType): T? =
            find(entityClass, id, LockModeConverter.convertToLockMode(lockModeType))
         ...
         */
        @JvmSynthetic
        suspend fun <T> find(entityGraph: EntityGraph<T>, id: Any?): T?
         ...
         */
        @JvmSynthetic
        suspend fun <T> find(entityClass: Class<T>, vararg ids: Any?): List<T?>
        ...
        @Incubating
        @JvmSynthetic
        suspend fun <T> find(entityClass: Class<T>, naturalId: Identifier<T>): T?
         ...
         */
        fun <T> getReference(entityClass: Class<T?>?, id: Any?): T?
         ...
         */
        @JvmSynthetic
        suspend fun persist(entityName: String?, instance: Any?)
         ...
         */
        @JvmSynthetic
        suspend fun refresh(entity: Any?, lockMode: LockMode?)
         ...
         */
        @JvmSynthetic
        suspend fun refresh(entity: Any?, lockModeType: LockModeType) {
        ...
        @Suppress("REMOVAL")
        @JvmSynthetic
        suspend fun lock(entity: Any?, lockMode: LockMode?)
        ...
        @Suppress("REMOVAL")
        @JvmSynthetic
        suspend fun lock(entity: Any?, lockModeType: LockModeType) {
         ...
         */
        @JvmSynthetic
        suspend fun <E, T> fetch(entity: E?, field: Attribute<E, T>): T?
         ...
         */
        fun setFlushMode(flushModeType: FlushModeType): Session =
            setFlushMode(FlushModeTypeHelper.getFlushMode(flushModeType))
         ...
         */
        fun setReadOnly(entityOrProxy: Any, readOnly: Boolean): Session
         ...
         */
        fun setCacheStoreMode(cacheStoreMode: CacheStoreMode?): Session = setCacheMode(
            CacheModeHelper.interpretCacheMode(
                cacheStoreMode,
                CacheModeHelper.interpretCacheRetrieveMode(this.getCacheMode()),
            ),
         ...
         */
        fun setCacheRetrieveMode(cacheRetrieveMode: CacheRetrieveMode?): Session = setCacheMode(
            CacheModeHelper.interpretCacheMode(
                CacheModeHelper.interpretCacheStoreMode(this.getCacheMode()),
                cacheRetrieveMode,
            ),
    ...
    interface StatelessSession :
         ...
         */
        @JvmSynthetic
        suspend fun <T> get(entityClass: Class<T>, id: Any?): T?
         ...
         */
        @JvmSynthetic
        suspend fun <T> get(entityClass: Class<T>, vararg ids: Any): List<T?>
         ...
         */
        @JvmSynthetic
        suspend fun <T> get(entityClass: Class<T>, id: Any, lockMode: LockMode): T?
         ...
         */
        @JvmSynthetic
        suspend fun <T> get(entityClass: Class<T>, id: Any, lockModeType: LockModeType): T? =
            get(entityClass, id, LockModeConverter.convertToLockMode(lockModeType))
         ...
         */
        @JvmSynthetic
        suspend fun <T> get(entityGraph: EntityGraph<T>, id: Any): T?
         ...
         */
        @JvmSynthetic
        suspend fun insertAll(batchSize: Int, vararg entities: Any)
         ...
         */
        @JvmSynthetic
        suspend fun insertMultiple(entities: List<Any>) {
         ...
         */
        @JvmSynthetic
        suspend fun deleteAll(batchSize: Int, vararg entities: Any?)
        ...
        suspend fun deleteMultiple(entities: List<*>) {
            deleteAll(*entities.toTypedArray())
        }
         ...
         */
        @JvmSynthetic
        suspend fun updateAll(batchSize: Int, vararg entities: Any?)
        ...
        suspend fun updateMultiple(entities: List<*>) {
            updateAll(*entities.toTypedArray())
        }
        ...
        @Incubating
        @JvmSynthetic
        suspend fun upsertAll(batchSize: Int, vararg entities: Any?)
         ...
         */
        @JvmSynthetic
        suspend fun refreshAll(batchSize: Int, vararg entities: Any?)
        ...
        suspend fun refreshMultiple(entities: List<*>) {
            refreshAll(*entities.toTypedArray())
        }
    ...
    interface SessionFactory : AutoCloseable {
         ...
         */
        @JvmSynthetic
        suspend fun <T> withSession(tenantId: String, work: suspend (Session) -> T): T
         ...
         */
        @JvmSynthetic
        suspend fun <T> withTransaction(work: suspend (Session) -> T): T =
            withTransaction { session, _ -> work(session) }
         ...
         */
        @JvmSynthetic
        suspend fun <T> withStatelessSession(tenantId: String?, work: suspend (StatelessSession) -> T): T
         ...
         */
        @JvmSynthetic
        suspend fun <T> withTransaction(tenantId: String, work: suspend (Session, Transaction) -> T): T =
            withSession(tenantId) { s -> s.withTransaction { t -> work(s, t) } }
    ...
    interface Closeable {
        ...
        fun closeAsStage(): CompletionStage<Void> = CoroutineScope(EmptyCoroutineContext).future {
